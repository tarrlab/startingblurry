...
model = resnet50()
loaded_state_dict = torch.load('trials/Colored/' + trialNumber + '/ColoredLinearBlurModel.pt')
'''
...
filename = 'trials/ColoredImgNet/' + trialNumber + '/trainingLogColoredLinearBlurModel.csv'
...
for epoch in range(numEpochs):
    ...
    if (num_correct_validation/len(val_dataset) > best_accuracy):
        torch.save(model.state_dict(), 'trials/ColoredImgNet/' + trialNumber + '/ColoredLinearBlurModel.pt')
