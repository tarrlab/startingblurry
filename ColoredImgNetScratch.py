...
filename = '/home/ojinsi/trials/Colored50ImgNet/2/trainingLogColoredModel.csv'
...
for epoch in range(numEpochs):
    ...
    if (num_correct_validation/len(val_dataset) > best_accuracy): 
        torch.save(model.state_dict(), '/home/ojinsi/trials/Colored50ImgNet/2/ColoredModel.pt')
