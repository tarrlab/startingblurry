...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, index):
        img = Image.open(self.img_lst[self.current_indicies[index]]).convert('RGB')
...
filename = 'labelAccuracy/Colored/NonLinearLabelAccuracy.csv'
...
for i in range(1, 11):
    ...
    loaded_state_dict = torch.load('trials/ColoredImgNet/'+ str(i) +'/ColoredNonLinearBlurModel2.pt')
...
filename = 'labelAccuracy/Colored/LinearLabelAccuracy.csv'
...
for i in range(1, 11):
    ...
    num_ftrs = model.fc.in_features
    model.fc = nn.Linear(num_ftrs, 1000)
    loaded_state_dict = torch.load('trials/ColoredImgNet/'+ str(i) +'/ColoredLinearBlurModel.pt')
    '''
...
filename = 'labelAccuracy/Colored/NoBlurLabelAccuracy.csv'
...
for i in range(1, 11):
    ...
    num_ftrs = model.fc.in_features
    model.fc = nn.Linear(num_ftrs, 1000)
    loaded_state_dict = torch.load('trials/ColoredImgNet/'+ str(i) +'/ColoredNoBlurModel.pt')
    '''
    You probably do not need correct_state_dict.
...
filename = 'labelAccuracy/Colored/ControlLabelAccuracy.csv'
...
for i in range(1, 11):
    ...
    num_ftrs = model.fc.in_features
    model.fc = nn.Linear(num_ftrs, 1000)
    loaded_state_dict = torch.load('trials/ColoredImgNet/'+ str(i) +'/ColoredModel.pt')
    '''
    You probably do not need correct_state_dict.
