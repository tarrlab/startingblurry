...
scheduler = scheduler = torch.optim.lr_scheduler.ExponentialLR(optimizer=optimizer, gamma = .99, verbose = True)
...
filename = '/home/ojinsi/trials/10/trainingLog50BWNonLinearBlurModel2.csv'
...
for epoch in range(numEpochs):
    ...
    if (num_correct_validation/len(val_dataset) > best_accuracy): 
        torch.save(model.state_dict(), '/home/ojinsi/trials/10/50BWNonLinearBlurModel2.pt')
