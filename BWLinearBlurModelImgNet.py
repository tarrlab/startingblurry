...
model = resnet50()
loaded_state_dict = torch.load('/home/ojinsi/trials/BW50/6/50BWLinearBlurModel.pt')
...
filename = '/home/ojinsi/trials/BW50ImgNet/6/trainingLog50BWLinearBlurModel.csv'
...
for epoch in range(numEpochs):
    ...
    if (num_correct_validation/len(val_dataset) > best_accuracy): 
        torch.save(model.state_dict(), '/home/ojinsi/trials/BW50ImgNet/6/50BWLinearBlurModel.pt')
