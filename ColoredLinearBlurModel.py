...
filename = '/home/ojinsi/trials/Colored50/10/trainingLog50ColoredLinearBlurModel.csv'
...
for epoch in range(numEpochs):
    ...
    if (num_correct_validation/len(val_dataset) > best_accuracy): 
        torch.save(model.state_dict(), '/home/ojinsi/trials/Colored50/10/50ColoredLinearBlurModel.pt')
