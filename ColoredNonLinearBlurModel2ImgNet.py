...
model = resnet50()
loaded_state_dict = torch.load('/home/ojinsi/trials/Colored50/5/50ColoredNonLinearBlurModel2.pt')
...
filename = '/home/ojinsi/trials/Colored50ImgNet/5/trainingLog50ColoredNonLinearBlurModel2.csv'
...
for epoch in range(numEpochs):
    ...
    if (num_correct_validation/len(val_dataset) > best_accuracy): 
        torch.save(model.state_dict(), '/home/ojinsi/trials/Colored50ImgNet/5/50ColoredNonLinearBlurModel2.pt')
